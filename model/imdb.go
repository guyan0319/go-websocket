...
// Message 消息表
type Message struct {
	ID       int64     `gorm:"column:id;type:bigint(20) unsigned;not null"`                          // ID
	MsgSerID uint64    `gorm:"index:msg_ser_id;column:msg_ser_id;type:bigint(20) unsigned;not null"` // 服务端消息id
	GroupsID int       `gorm:"index:groups_id;column:groups_id;type:int(10)"`                        // 群id
	FromUId  int64     `gorm:"index:from_uid;column:from_uid;type:bigint(20) unsigned;not null"`     // 发送方UID
	ToUId    int64     `gorm:"index:to_uid;column:to_uid;type:bigint(20) unsigned;not null"`         // 接收方UID
	...
	Appname  int8      `gorm:"column:appname;type:tinyint(3) unsigned;not null"`                     // 应用名称
	...
	AdminID  int       `gorm:"column:admin_id;type:int(10) unsigned;not null"`                       // 审核人
